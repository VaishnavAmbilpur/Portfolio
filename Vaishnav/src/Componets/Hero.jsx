  ...
  return (
      ...
      <div className='backdrop-blur-1xl my-10 p-3 text-white min-h-90 w-screen font-Josefin items-start md:mx-10 md:pl-25 relative z-10'>
        <div className='m-7 text-5xl md:text-7xl tracking-widest'>
          ...
          <div className='me'>
            <div className='font-sans font-extrabold m-2 text-xs  w-fit tracking-widest transition delay-50 duration-300  md:text-sm text-red-50 hover:translate-x-1  transition-normal'>
...
It’s a thrilling mix of genius, frustration, and too much coffee.
           ...
           <a 
  href='https://drive.google.com/file/d/1hb5F8aU4vV0RM5tZ2p2KgDuYTpS9TFPY/view?usp=sharing' 
