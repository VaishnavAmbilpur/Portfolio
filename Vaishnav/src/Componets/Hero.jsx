...
const Hero = () => {
  ...
  return (
    <div className='backdrop-blur-1xl m-1 p-3 overflow-x-hidden text-white h-1-24 w-screen font-playfiar items-start md:m-10 md:pl-25'>
        ...
        <div className="md:flex flex-row " id='h'>
           <div className='flex mt-0 mx-8 md:mt-4'><div className="text-red-50 flex flex-row gap-8 mt-5 md:flex-col">
              <div className='flex gap-1 items-center'><HouseSimple size={`19`} weight="thin" /><span>Home</span></div>
              <div className='flex gap-1 items-center'><Info size={19} weight="thin" /><span>Info</span></div>
              <div className='flex gap-1 items-center'><AppWindow size={19} weight="thin" /><span>Projects</span></div>
           </div>
        </div>
